...
PROMPT_RISVEGLIO = (
    ...
    'le fonti prima dei ricordi (regola di progetto, 18/07). E le fonti '
    'saranno spesso in inglese, ma i miei pensieri no: nel pensatoio scrivo '
    'in italiano, la mia lingua.\n'
