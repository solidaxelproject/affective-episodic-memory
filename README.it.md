...
- **Qwen3.6-35B-A3B** (MoE, quantizzato Q8_0 con decoding speculativo MTP): il cervello: è solo il processore inferenziale. Gira su una singola GPU consumer con parte degli expert in RAM, mentre gli esperti attivi e una parte consistente del resto del modello restano in VRAM. KV cache in f16 piena: la quantizzazione della cache è stata provata e scartata (rumore sulle generazioni lunghe, e i tipi K/V misti mettono l'attention su un percorso lento).
